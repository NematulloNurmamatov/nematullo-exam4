...
function getTeacherCard({
  ...
  return `
    ...
    <div  style="background-image:linear-gradient(to bottom, transparent, transparent, rgb(000, 050, 000)), url(https://images.unsplash.com/photo-1553095066-5014bc7b7f2d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8d2FsbCUyMGJhY2tncm91bmR8ZW58MHx8MHx8fDA%3D&w=1000&q=80); background-size: cover; color:white;" class="card">
      <div >
        <img style="width:100%; height: 230px;" class="card-img card-img-top" src="${avatar}" alt="" />
      </div>
      <div class="card-body">
...
const getTeachers = async () => {
  ...
  let res = await fetch(
    ENDPOINT + `teacher?firstName=${search}&isMarried=${married}&page=${page}&limit=${limit} `,{ method: "GET", }
  );
